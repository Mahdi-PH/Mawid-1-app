      ...
      <div className="relative flex flex-col items-center gap-3">
        ...
        >
          <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <g transform="translate(31.04,-48) scale(6.08)">
              <path
                d="M46,18 C36,18 28,26 27,36 C26,42 22,44 18,46 C23,49 25,54 25,60 L28,70 C31,77 38,82 47,82 L47,66 C47,66 40,60 40,50 C40,38 46,30 56,28"
                fill="#f5fbf9"
              />
            </g>
          </svg>
